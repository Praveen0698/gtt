...
const FuelViewallTable: React.FC = () => {
  ...
  const fetchShift = async () => {
    setIsLoading(true);
    try {
      const res = await axios.get(`/api/fuel/getall/${empId}/${projectId}`);
  ...
  const handleMaintenanceView = (id: string) => {
    setIsLoading(true);
    router.push(
      `/fuel/view?fuelId=${id}&empId=${empId}&projectId=${projectId}&projectName=${projectName}`
    );
  };
  ...
  const deleteClick = async (id: string) => {
    setIsLoading(true);
    await axios
      .delete(`/api/fuel/delete`, { data: { id } })
      .then(() => {
        fetchShift();
      })
        ...
        <section className="firm-main-container">
          ...
          <div className="table-main-container">
            <div className="title-button-container">
              <h3 className="table-h3">All Fuel Expenses</h3>
            </div>
                      ...
                      >
                        ...
                        <TableCell style={{ textAlign: "center" }}>
                          <FaEye
                            ...
                            style={{ color: "blue" }}
                            onClick={() => handleMaintenanceView(row._id)}
                          />
                        </TableCell>
                        <TableCell style={{ textAlign: "center" }}>
                          <MdDelete
...
export default FuelViewallTable;
