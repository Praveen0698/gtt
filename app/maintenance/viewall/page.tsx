...
const MaintenanceViewTable: React.FC = () => {
  ...
  const handleMaintenanceView = (id: string) => {
    setIsLoading(true);
    router.push(
      `/maintenance/view?maintenanceId=${id}&empId=${empId}&projectId=${projectId}&projectName=${projectName}`
    );
  };
  ...
  const deleteClick = async (id: string) => {
    setIsLoading(true);
    await axios
      .delete(`/api/vehicle/maintenance/delete`, { data: { id } })
      .then(() => {
        fetchShift();
      })
      ...
      <section className="firm-main-container">
        ...
        <div className="table-main-container">
          <div className="title-button-container">
            <h3 className="table-h3">All Maintenance Expenses</h3>
          </div>
